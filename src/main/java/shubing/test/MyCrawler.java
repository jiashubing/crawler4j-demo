...
public class MyCrawler extends WebCrawler {
     ...
     * 正则匹配指定的后缀文件
     */
//    private final static Pattern FILTERS = Pattern.compile(".*(\\.(jpg))$");
//    private final static Pattern FILTERS = Pattern.compile(".*(\\.(css|js|gif|jpg"
//                                                           + "|png|mp3|zip|gz))$");
    private final static Pattern FILTERS = Pattern.compile("http://info.zufe.edu.cn/xx_nry.jsp.*");
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        return url.getURL().contains("a4c=1000");
